...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SuperPong", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SuperPong", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.rapidfingers.SuperPong";
